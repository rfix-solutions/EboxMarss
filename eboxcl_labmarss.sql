...
-- Tiempo de generación: 29-10-2018 a las 13:51:49
...
INSERT INTO `TBL_Laboratorista` (`id_laboratorista`, `nombre_laboratorista`) VALUES
(1, 'Carlos Silva'),
(2, 'Juan Hernandez'),
(3, 'Andres Cortes'),
(4, 'Felipe Soto'),
...
(7, 'Alvaro Soto'),
(8, 'Esteban Gomez'),
(9, 'Patricio Sepulveda'),
(10, 'Claudio Gonzalez'),
(11, 'Guillermo Fuentes'),
(12, 'Francisco Galdamez'),
(13, 'Victor Hidalgo'),
(14, 'Luis Castro'),
(15, 'Sin Asignacion');
...
INSERT INTO `TBL_Usuario` (`id_usuario`, `rut_usuario`, `password`, `nombre_usuario`, `apellido_paterno`, `apellido_materno`, `telefono_fijo_usuario`, `telefono_movil_usuario`, `email_usuario`, `id_tipo_usuario`, `id_sucursal`, `id_area_empresa`, `id_cargo_empresa`, `id_centro_costo`, `sigla_usuario`) VALUES
(1, '164568571', '164568571', 'Edmundo', 'Sarria', 'Inzulza', 9, 0, 'edmundo.sarria@tecnotrack.cl', 1, 2, 1, 1, 1, 'ES'),
(2, '173551711', '173551711', 'Alejandro', 'Vargas', 'V', 24252627, 92939495, 'jefe.laboratorio@marsslab.cl', 1, 1, 1, 1, 1, 'AV');
