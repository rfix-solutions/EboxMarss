...
-- Tiempo de generación: 26-02-2019 a las 22:58:42
...
--
-- Estructura de tabla para la tabla `bak.tbl_designacion_moldes`
--

CREATE TABLE `bak.tbl_designacion_moldes` (
...
--
-- Estructura de tabla para la tabla `bak.tbl_hormigon`
--

CREATE TABLE `bak.tbl_hormigon` (
...
(1, '764183347', 'Empresa Mandante S.A.', 'obra de prueba', 'Av circunvalación s/n', 'Pablo Viveros', 'CONTACTO@RFIX.CL', 123455432, 14, 7, '2019-02-14', '13:00:00', '13:30:00', 'Sin observaciones', '2019-02-14', 1, 1),
(2, '764183347', 'Empresa Mandante S.A.', 'obra de prueba', 'Av circunvalación s/n', 'Pablo Viveros', 'CONTACTO@RFIX.CL', 123455432, 73, 8, '2019-02-14', '13:00:00', '13:30:00', 'Sin observaciones', '2019-02-14', 1, 1);
...
(1, '76765622k', 'sadksdlfkn', 'papasda', 'sldksldkf', 'Alfredo', '76543212', 'contacto@rfix.cl', 1, 1, 1, 1, 1);
...
--
-- Volcado de datos para la tabla `TBL_Correlativo`
--

INSERT INTO `TBL_Correlativo` (`Correlativo_Id`, `Correlativo_Numero`, `Correlativo_IdLaboratorista`, `Correlativo_Estado`) VALUES
(1, '1', 11, 1),
(2, '2', 11, 1),
(3, '3', 11, 1),
(4, '4', 11, 1),
...
(1, 1, 3, 3, 4, 'SCL-1-2019', 1, 'PAPASDA', '2019-02-13 23:31:46', 1, 'ALFREDO', 'CONTACTO@RFIX.CL', 1, 15, 1),
(2, 1, 3, 1, 1, 'SCL-2-2019', 1, 'PAPASDA', '2019-02-14 16:27:11', 1, 'ALFREDO', 'CONTACTO@RFIX.CL', 1, 15, 2),
(3, 1, 3, 1, 3, 'SCL-3-2019', 1, 'PAPASDA', '2019-02-14 16:30:10', 1, 'ALFREDO', 'CONTACTO@RFIX.CL', 1, 15, 3);
...
(1, 1, 'SCL-1-2019', 1, 66, 1.40),
(2, 1, 'SCL-1-2019', 1, 29, 4.00),
(3, 3, 'SCL-3-2019', 1, 74, 2.00),
(4, 3, 'SCL-3-2019', 1, 66, 1.40);
...
(2, 2, 'SCL-2-2019', 1, 1, 13.00, 1),
(3, 2, 'SCL-2-2019', 1, 3, 0.48, 1),
(4, 3, 'SCL-3-2019', 1, 1, 13.00, 1),
(5, 3, 'SCL-3-2019', 1, 3, 0.48, 1);
...
(1, 1, 'Cotizacion enviada a cliente', '2019-02-13 23:31:52', 1),
(2, 1, 'Cotizacion enviada a cliente', '2019-02-13 23:37:41', 1),
(3, 1, 'Cotizacion enviada a cliente', '2019-02-13 23:53:53', 1),
(4, 1, 'Cotizacion enviada a cliente', '2019-02-14 00:09:34', 1),
(5, 1, 'Cotizacion aceptada por el cliente', '2019-02-14 11:31:02', 1),
(6, 1, 'Se agenda visita para el 2019-02-14 de 13:00 a 13:30 horas.', '2019-02-14 11:38:25', 1),
(7, 1, 'Cotizacion enviada a cliente', '2019-02-14 16:31:47', 1),
(8, 3, 'Cotizacion aceptada por el cliente', '2019-02-14 16:39:20', 2),
(9, 1, 'Se agenda visita para el 2019-02-14 de 13:00 a 13:30 horas.', '2019-02-14 16:52:25', 1);
...
(10, 1, 'Ruptura Probeta Mortero (RILEM)', 53, 1, 0.33, 1),
(11, 1, 'Compresión Cilindro Hormigón', 30, 1, 0.51, 1),
(12, 1, 'Compresión Cubo Hormigón ', 23, 1, 0.48, 1),
(13, 1, 'Flexo tracción Hormigón', 24, 1, 0.53, 1),
...
(1, 'papasda', '2019-02-14', 'ALFREDO', 'CONTACTO@RFIX.CL', 'constructora sa', 'obra de prueba', 'OBR-001', 'Av circunvalación s/n', '97', '123455432', 'Javier Vallenilla', 'javier.vallenilla@test.cl', '76543211', 1, 'Quien Recibe SA', 'Aldo Palma', 'Empresa Mandante S.A.', '764183347', 'Constructora', 'Lago Ranco S/N', '105', 3, 2, 2, '65432112345', 'facturas@mandante.cl', 'Pablo Viveros', 1, 1),
(2, 'SADKSDLFKN', '2019-02-14', 'SADKSDLFKN', 'CONTACTO@RFIX.CL', 'N/A', 'PAPASDA', 'N/A', 'SLDKSLDKF', '0', '76543212', 'ALFREDO', 'CONTACTO@RFIX.CL', '76543212', 4, 'SADKSDLFKN', 'ALFREDO', 'SADKSDLFKN', '76765622k', '50', 'SLDKSLDKF', '50', 4, 7, 0, '76543212', 'CONTACTO@RFIX.CL', 'SADKSDLFKN', 1, 0),
(3, 'SADKSDLFKN', '2019-02-14', 'SADKSDLFKN', 'CONTACTO@RFIX.CL', 'N/A', 'PAPASDA', 'N/A', 'SLDKSLDKF', '0', '76543212', 'ALFREDO', 'CONTACTO@RFIX.CL', '76543212', 4, 'SADKSDLFKN', 'ALFREDO', 'SADKSDLFKN', '76765622k', '50', 'SLDKSLDKF', '50', 4, 7, 0, '76543212', 'CONTACTO@RFIX.CL', 'SADKSDLFKN', 1, 0);
...
INSERT INTO `TBL_FormHM` (`id_form_c_h_m`, `id_agendamiento_visita`, `id_tipo_ensayo`, `numero_solicitud`, `correlativo_obra`, `fecha_solicitud`, `hora_ini`, `hora_fin`, `kilometraje`, `realizado_por`, `cantidad_muestras`) VALUES
(1, 2, 1, '7654-1', '987654', '2019-02-14 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 6543, '8', 2),
(2, 2, 1, '7654-2', '987654', '2019-02-14 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 6543, '8', 2);
...
CREATE TABLE `TBL_FormHMDet` (
  `FormHMDetalle_Id` int(10) NOT NULL,
  `FormHMDetalle_ProbetaId` int(10) NOT NULL,
  `FormHMDetalle_FormHMId` int(10) NOT NULL,
...
INSERT INTO `TBL_FormHMDet` (`FormHMDetalle_Id`, `FormHMDetalle_ProbetaId`, `FormHMDetalle_FormHMId`, `FormHMComp_Id`, `FormHMMov_Id`, `FormHMTipoCurado_Id`, `FormHMDetRE_Id`, `FormHMPro_Id`, `FormHMMarca_Id`, `FormHMAs_Id`, `FormHMTex_Id`, `cod_hormigon`, `fecha_muestra`, `hora_control`, `correlativo`, `DesigMoldeUtil`, `hora_carga_planta`, `hora_salida_planta`, `hora_llegada_planta`, `hora_inicio`, `hora_termino`, `curado_obra`, `responsable_muestreo`, `lugar_extraccion`, `dosificacion_declarada`, `camion`, `guia`, `m3`, `cono`, `elemento_hormigonado`, `aditivos`, `observaciones`, `termometro`, `equipo_cono`, `vibrador_sonda`, `regla_metrica`, `otros`, `edad`) VALUES
(1, 0, 0, 0, 2, 1, 23, 1, 0, 3, 1, '4326', '2019-02-14', '17:06:00', '656232', '1', '17:07:00', '17:07:00', '17:07:00', '17:07:00', '17:07:00', 'Curado', '8', 'Extraccion', '', 'XCDC54', '3456', 5.00, 1, 'ELEMENTO', 'ADITIVO', 'NO HAY', '11232', 'KJN', 'KLN', 'LK', 'LKJ', 1),
(2, 0, 0, 0, 2, 1, 23, 1, 0, 3, 1, '4326', '2019-02-14', '17:06:00', '656232', '4', '17:07:00', '17:07:00', '17:07:00', '17:07:00', '17:07:00', 'Curado', '8', 'Extraccion', '', 'XCDC54', '3456', 5.00, 1, 'ELEMENTO', 'ADITIVO', 'NO HAY', '11232', 'KJN', 'KLN', 'LK', 'LKJ', 28);
...
--
-- Estructura de tabla para la tabla `TBL_FormHMPro`
--

CREATE TABLE `TBL_FormHMPro` (
...
--
-- Volcado de datos para la tabla `TBL_FormHMPro`
--

INSERT INTO `TBL_FormHMPro` (`FormHMPro_Id`, `FormHMPro_Nombre`) VALUES
(1, 'Maquina'),
(2, 'Pala');
...
(1, 2, '656-1', 1, '', '2019-02-14 00:00:00', '17:01:00', '17:02:00', 234567, '8', 4, 'No', 'Elliot', 1234567, '', '', '', '2019-02-14 17:01:53'),
(2, 2, '765434-1', 6, '', '2019-02-14 00:00:00', '17:28:00', '17:28:00', 123123, '8', 2, 'no', 'ed', 123123123, '', '', '', '2019-02-14 17:28:36');
...
(1, 1, 0, 1, '2019-02-14 17:01:53', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(2, 0, 1, 1, '2019-02-14 17:09:20', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(3, 0, 2, 1, '2019-02-14 17:09:20', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(4, 2, 0, 6, '2019-02-14 17:28:36', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1);
...
--
-- Indices de la tabla `bak.tbl_designacion_moldes`
--
ALTER TABLE `bak.tbl_designacion_moldes`
...
--
-- Indices de la tabla `bak.tbl_hormigon`
--
ALTER TABLE `bak.tbl_hormigon`
...
ALTER TABLE `TBL_Cliente`
  ADD PRIMARY KEY (`id_cliente`,`rut_cliente`) USING BTREE,
...
ALTER TABLE `TBL_FormHMDet`
  ADD PRIMARY KEY (`FormHMDetalle_Id`),
  ADD KEY `FormHMMarca_Id` (`FormHMMarca_Id`),
  ADD KEY `FormHMDetalle_FormHMId` (`FormHMDetalle_FormHMId`),
  ADD KEY `FormHMDetalle_ProbetaId` (`FormHMDetalle_ProbetaId`),
...
--
-- Indices de la tabla `TBL_FormHMPro`
--
ALTER TABLE `TBL_FormHMPro`
...
--
ALTER TABLE `TBL_AgendaVisitaDetalle`
  MODIFY `id_detalle_servicio_agendado` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `TBL_ClienteUsuarios`
  MODIFY `ClienteUsuarios_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `TBL_Correlativo`
  MODIFY `Correlativo_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;
...
--
ALTER TABLE `TBL_CotizacionDetalleDestino`
  MODIFY `id_detalle_destino_cotizacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `TBL_CotizacionDetalleEnsayos`
--
ALTER TABLE `TBL_CotizacionDetalleEnsayos`
  MODIFY `id_detalle_ensayo_cotizacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `TBL_EnsayoItem`
  MODIFY `id_ensayo_item` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `TBL_FormHM`
  MODIFY `id_form_c_h_m` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `TBL_FormHMDet`
  MODIFY `FormHMDetalle_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `TBL_FormHMMarca`
  MODIFY `FormHMMarca_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `TBL_FormHMMov`
--
ALTER TABLE `TBL_FormHMMov`
  MODIFY `FormHMMov_Id` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `TBL_FormHMPro`
--
ALTER TABLE `TBL_FormHMPro`
...
--
ALTER TABLE `TBL_FormHMTipoCurado`
  MODIFY `FormHMTipoCurado_Id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `TBL_FormSS`
--
ALTER TABLE `TBL_FormSS`
  MODIFY `id_form_solicitud_servicio` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `TBL_Informe`
  MODIFY `Informe_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `TBL_Laboratorista`
  MODIFY `id_laboratorista` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `TBL_Obra`
  MODIFY `Obra_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Filtros para la tabla `bak.tbl_hormigon`
--
ALTER TABLE `bak.tbl_hormigon`
  ADD CONSTRAINT `bak.tbl_hormigon_ibfk_2` FOREIGN KEY (`id_unidad_medida_c`) REFERENCES `tbl_unidad_medida_c` (`id_unidad_medida_c`) ON DELETE NO ACTION,
  ADD CONSTRAINT `bak.tbl_hormigon_ibfk_3` FOREIGN KEY (`id_unidad_medida_r`) REFERENCES `tbl_unidad_medida_r` (`id_unidad_medida_r`) ON DELETE NO ACTION,
  ADD CONSTRAINT `bak.tbl_hormigon_ibfk_4` FOREIGN KEY (`id_procedencia_obra`) REFERENCES `tbl_procedencia_obra` (`id_procedencia_obra`) ON DELETE NO ACTION,
  ADD CONSTRAINT `bak.tbl_hormigon_ibfk_5` FOREIGN KEY (`id_textura`) REFERENCES `TBL_FormHMTex` (`FormHMTex_Id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `bak.tbl_hormigon_ibfk_6` FOREIGN KEY (`id_aspecto`) REFERENCES `TBL_FormHMAs` (`FormHMAs_Id`) ON DELETE NO ACTION;
