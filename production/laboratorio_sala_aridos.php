      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          	...
          	<div class="title_left">
            	<h3>Bit&aacute;cora de Ensayos - &Aacute;ridos</h3>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="row">
            	...
            	<div class="x_panel">
								...
								<table id="Tabla_Aridos" class="table table-striped table-bordered nowrap" cellspacing="0" style="width:100%">
									<thead>
									<tr>
										<th>#</th>
										<th>Opcion</th>
										...
										<div class="modal-dialog modal-md">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title" id="modal_titulo_aridos">&Aacute;ridos</h4>
												</div>
