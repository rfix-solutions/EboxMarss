      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          	...
          	<div class="title_left">
            	<h3>Bit&aacute;cora de Ensayos - Elementos</h3>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="row">
            	...
            	<div class="x_panel">
								...
								<table id="Tabla_Elementos" class="table table-striped table-bordered nowrap" cellspacing="0" style="width:100%">
									<thead>
									<tr>
										<th>#</th>
										<th>Opcion</th>
											...
											while($DatEnsayo = mysqli_fetch_assoc($QryEnsayo)){
												...
												switch ($DatEnsayo['ESTADO']) {
												 case '0':
													 ...
													 $modal_div = "modal_elementos".$DatEnsayo['ID_SOLICITUD']."";
													 break;
									...
									while($DatModal = mysqli_fetch_assoc($QryModal)){
										...
										?>
									<div class="modal fade bs-example-modal-md" id="modal_elementos<?php echo $DatModal['ID_SOLICITUD'];?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog modal-md">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title" id="modal_titulo_elementos">&Aacute;ridos</h4>
												</div>
												<div class="modal-body">
													<form name="form_elementos<?php echo $DatModal['ID_SOLICITUD'];?>" id="form_elementos<?php echo $DatModal['ID_SOLICITUD'];?>" method="get" action="laboratorio-ensayos/elementos/ensayo_elementos_res.php">
														<?php
														$i=1;
														while($DatItem = mysqli_fetch_assoc($SqlItemModal)){
															...
															?>
															        ...
															        <tr>
															          ...
															          <td><input style="width:100%;" type="number" name="EnsayoItem<?php echo $ItemEnsayo['id_ensayo_item']?>" id="<?php echo $ItemEnsayo['id_ensayo_item']?>" value=""></td>
										...
										<div class="modal-dialog modal-md">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title" id="modal-titulo_elementos">Mensaje</h4>
												</div>
												<div class="modal-body">
			...
			<script>
				...
				function envia_form(){
					...
					nombre_form = "form_elementos"+nombre_form;
