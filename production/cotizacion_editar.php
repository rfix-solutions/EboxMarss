   ...
   <link href="../vendors/iCheck/skins/flat/green.css" rel="stylesheet">
	...
	<script type="text/javascript">
		...
		/*function cargarDatos(){
			...
			document.getElementById("rut_cliente").value = <?php echo $rut_cliente;?>
			document.getElementById("nombre_cliente").value = "<?php echo htmlspecialchars($cot_cliente); ?>"
			document.getElementById("nombre_proyecto").value = <?php echo $cot_proyecto;?>
			document.getElementById("localidad").value = <?php echo $cot_direccion;?>
			document.getElementById("contacto").value = <?php echo $cot_contacto;?>
			document.getElementById("email").value = <?php echo $cot_email;?>
			document.getElementById("origen").value = <?php echo $cot_origen;?>
		}*/
...
<!-- CONTENIDO DE PAGINA -->
<form name="editar_cotizacion" onSubmit="return validar(this)" action="editar_cotizacion_res.php" method="get">
			...
			<div class="form-group">
				<div class="col-md-6">
                	<input type="text" required oninput="checkRut(this)"  value="<?php echo htmlspecialchars($rut_cliente); ?>" class="form-control has-feedback-left" id="rut_cliente" placeholder="Rut Cliente" name="rut_cliente">
					<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
					</br>
				</div>
				<div class="col-md-6">

                	<input type="text" onKeyPress="return soloLetras(event)" required class="form-control has-feedback-left" id="nombre_cliente" placeholder="Nombre Cliente" value="<?php echo htmlspecialchars($cot_cliente); ?>" name="nombre_cliente">
					<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
					</br>
                </div>
            </div>
			...
			<div class="form-group">
				<div class="col-md-6">
                	<input type="text" onKeyPress="return letrasYnumeros(event)" required class="form-control has-feedback-left" id="nombre_proyecto" placeholder="Nombre Proyecto" value="<?php echo htmlspecialchars($cot_proyecto); ?>" name="nombre_proyecto">
					<span class="fa fa-file-text-o form-control-feedback left" aria-hidden="true"></span>
					</br>
				</div>

				<div class="col-md-6">
                	<input type="text" required class="form-control has-feedback-left" value="<?php echo htmlspecialchars($cot_direccion); ?>" id="localidad" placeholder="Localidad Proyecto" name="localidad">
 			...
 			<div class="form-group">
				<div class="col-md-6">
                	<input type="text" onKeyPress="return soloLetras(event)" required class="form-control has-feedback-left" id="contacto" value="<?php echo htmlspecialchars($cot_contacto); ?>" placeholder="Contacto Cliente" name="contacto">
					<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
					</br>
				</div>

				<div class="col-md-6">
                	<input type="email" required class="form-control has-feedback-left" id="email" value="<?php echo htmlspecialchars($cot_email); ?>" placeholder="Email" name="email">
            ...
            <div class="form-group">
				...
				<div class="col-md-6">
                	<select class="form-control" value="<?php echo htmlspecialchars($cot_origen); ?>" required="required" id="origen" name="origen">
...
<br>
		...
		<div class="form-group">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
				<input type="radio" class="flat" name="tipo_descuento" onclick="document.getElementById('valor_descuento').disabled=false;" onChange="changeStatus();" id="descuento_g" value="1" />
				General
				<br>
				<input type="radio" class="flat" name="tipo_descuento" onclick="document.getElementById('valor_descuento').disabled=false;" onChange="changeStatus();" id="descuento_e" value="2" />
				Ensayo
                <br>
                <input type="radio" class="flat" name="tipo_descuento" onclick="document.getElementById('valor_descuento').disabled=true;" onChange="changeStatus();" id="descuento_s" value="3" />
				Sin Descuento
			</div>
			<div class="col-md-3 col-sm-4 col-xs-12">
				<input type="number" min="0" max="100" step="0.01" class="form-control has-feedback-left" id="valor_descuento" placeholder="%" name="valor_descuento" style="width: 110px;"
    ...
    <br>
		...
		<div class="form-group" align="right">
			<div class="col-md-12">
				<button type="button" onClick="Javascript:location.href='dashboard_comercial.php';" class="btn btn-primary">Cancelar</button>
