      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          	...
          	<div class="title_left">
            	<h3>Bit&aacute;cora de Ensayos - Aguas</h3>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="row">
            	...
            	<div class="x_panel">
								...
								<table id="aguas" class="table table-striped table-bordered nowrap" cellspacing="0" style="width:100%">
									<thead>
									<tr>
										<th>#</th>
										<th>Opcion</th>
									...
									<tbody>
										<?php
											$QryEnsayo = mysqli_query($link, $sql_tab1) or die ("Error en Qry Ensayo " . mysqli_error($link));;
											$QryModal = mysqli_query($link, $sql_tab2) or die ("Error en Qry Modal " . mysqli_error($link));;
											$i=1;
											$hoy = date("Y-m-d");
											while($DatEnsayo = mysqli_fetch_assoc($QryEnsayo)){
												...
												switch ($DatEnsayo['ESTADO']) {
												 case '0':
													 ...
													 $modal_div = "modal_aguas".$DatEnsayo['ID_SOLICITUD']."";
													 break;
												...
												<tr>
													...
													<td><?php echo $i; ?></td>
													<td>
														<button type="button" onclick="numero_muestra(<?php echo $DatEnsayo['MUESTRA']?>)" data-toggle="modal" data-target="#<?php echo $modal_div;?>" class="<?php echo $ButtonClass; ?>"><?php echo $ButtonName;?></button>
													</td>
									...
									while($DatModal = mysqli_fetch_assoc($QryModal)){
										...
										?>
									<div class="modal fade bs-example-modal-md" id="modal_aguas<?php echo $DatModal['ID_SOLICITUD'];?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog modal-md">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title" id="modal_titulo_aguas">Aguas</h4>
												</div>
												<div class="modal-body">
													<form name="form_aguas<?php echo $DatModal['ID_SOLICITUD'];?>" id="form_aguas<?php echo $DatModal['ID_SOLICITUD'];?>" method="get" action="laboratorio-ensayos/aguas/ensayo_aguas_ressss.php">
														...
														while($DatItem = mysqli_fetch_assoc($SqlItemModal)){?>
															<div class="row">
															        ...
															        <tr>
															          ...
															          <td><input type="text" name="EnsayoItem<?php echo $ItemEnsayo['id_ensayo_item']?>" id="<?php echo $ItemEnsayo['id_ensayo_item']?>" value=""></td>
																      ...
																      <tr>
																        <td >FECHA ENSAYO</td>
																        <td colspan="2"><input style="width:100%;" type="date" name="fecha_ensayo_<?php echo $DatItem['ID_ENSAYO']?>" id="fecha_ensayo_<?php echo $DatItem['ID_ENSAYO']?>" value=""></td>
																      </tr>
																    	</tbody>
																  	</table>
																	</div>
									...
									//include("laboratorio-ensayos/aguas/ensayo_aguas.php");
										...
										<div class="modal-dialog modal-md">
											<div class="modal-content">
												<div class="modal-header">
													...
													<h4 class="modal-title" id="modal-titulo_aguas">Mensaje</h4>
												</div>
												<div class="modal-body">
			...
			<script>
				...
				function numero_muestra(dato){

					document.getElementById('NM').value = dato;
				...
				function envia_form(){
					nombre_form = "form_aguas"+nombre_form;
