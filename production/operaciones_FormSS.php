...
while($fila = mysqli_fetch_assoc($sql)){
	...
	$if_fecha = $fila['FECHA'];
	$if_constructora = $fila['CONSTRUCTORA'];
	$if_email = $fila['EMAIL'];
...
nextinput++;
campo = 'Campo:<input type="text" name="<?php while($cantidad > 0){ $name = "variable".$cantidad; echo $name; }?>"size="20" id="campo' + nextinput + '"&nbsp; />';
$("#campos").append(campo);
}
</script>
  </head>
...
<form class="form-horizontal form-label-left" method="get" action="operaciones_FormSSres.php">
<!-- /////////////////////////// SECCION 1 ///////////////////////////////////////// -->
...
<input type="hidden" name="te" value="<?php echo $_GET['te'];?>">
	...
	<div class="form-group row">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
      	<input type="text" class="form-control" name="construye" placeholder="Escriba" readonly required value="<?php echo $if_constructora;?>">
			</div>
	</div>
	<div class="form-group row">
