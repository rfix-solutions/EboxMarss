...
?>										
		...
		<div class="form-group">
			<div class="col-md-6">
				<h4 style="text-align: left;" class="col-md6">
					<strong>Destino</strong>
				</h4>
				<input type="text" required oninput="checkRut(this)"class="form-control" id="rut_cliente" placeholder="Rut Cliente" name="rut_cliente">
				<br><br>
			</div>			
			<div class="col-md-6">
				<h4 style="text-align: left;" class="col-md6">
				...
				<input type="text" onKeyPress="return soloLetras(event)" required class="form-control " id="nombre_cliente" placeholder="Nombre Cliente" name="nombre_cliente">
				<br><br>
			</div>
		</div>
