...
$pdf->MultiCell(185,5,utf8_decode('A continuación, se presentan valores correspondientes a los servicios de laboratorio para Obras Civiles, presentación de cotización en modalidad de Precio Unitario.'),0,'J');
				...
				$pdf->Cell(10,5,utf8_decode('ID'),0,0,'C');
				$pdf->Cell(15,5,utf8_decode('Precio'),0,0,'C');
				$pdf->Cell(158,5,utf8_decode('Ensayo'),0,1,'C');
...
$sql2 = mysqli_query($link, "SELECT 
				...
				//$pdf->MultiCell(15,5,$ensayo_id,0,0,'L');
				//$pdf->SetFont('Arial','',8.5);
				//$pdf->MultiCell(140,5,utf8_decode($ensayo_nombre),0,0,'L');
				//$pdf->MultiCell(12,5,$ensayo_precio,0,1,'L');
				$pdf->Cell(10,15,utf8_decode($ensayo_id),1,0,'C');
				$pdf->Cell(15,15,utf8_decode($ensayo_precio),1,0,'C');
				$pdf->MultiCell(155,5,utf8_decode($ensayo_nombre),1,1,'L');
...
$sql3 = mysqli_query($link, "
					...
					FROM 
						tbl_destino a, tbl_detalle_destino_cotizacion b
					WHERE 
					...
					while($row3 = mysqli_fetch_assoc($sql3)){
						...
						$pdf->Cell(185,5,utf8_decode('Valor de visita de laboratorio a: '.$destino_nombre.' UF '.							                        $destino_precio),0,1,'C');
					}
					$pdf->SetFont('Arial','B',10);
					$pdf->Ln();
					$pdf->Cell(185,5,utf8_decode('Total: '.$total.' UF '),0,1,'C');
