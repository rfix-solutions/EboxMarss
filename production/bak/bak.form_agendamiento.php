...
<body class="nav-md footer_fixed"  role="main">
        	...
        	<div class="col-md-12 ">
			    ...
			    <div class="row">
              		<div class="col-md-12 col-sm-12 col-xs-12">
            	    	<div class="x_panel">
                  			<div class="x_content">
								<h3 style="text-align: center;" class="col-md-12">
									<strong><?php echo $titulo;?></strong>
								</h3>
<!-- CONTENIDO DE PAGINA -->
<form name="agendar_visita" onSubmit="return validar(this)" action="#" method="get">
 ...
 oninput="setCustomValidity('')" value="<?php echo $cot_telefono;?>">
	...
	<div class="form-group">
		<div class="col-md-12">
			<h4 style="text-align: left;" class="col-md-12"><strong>Tipo de Servicio</strong></h4>
		</div>
	</div>
							...
							<!-- Inicio de tabla con checkbox -->
								<table class="table table-striped jambo_table" >
									...
									<tr class="<?php echo $class; ?>">
										...
										<td><input type="number" step="0" min="0" id="precio_ensayo" name="cantidad<?php echo $row2['ID'];?>" value="0" style="max-width:50px;"></td>
	...
	<div class="form-group">
		<div class="col-md-6">
			<h4 style="text-align: left;" class="col-md-6"><strong>Laboratorista</strong></h4>				
		<?php 
		...
		<div class="col-md-6">
			<h4 style="text-align: left;" class="col-md-6"><strong>Vehiculo</strong></h4>
			<select class="form-control" required="required" id="origen" name="origen">
				<option value="">-- Seleccione Vehículo --</option>
				<?php 
				$sql4 = mysqli_query($link, "SELECT * FROM tbl_laboratorista") or die('Consulta fallida: '.mysql_error());;
				while($filas = mysqli_fetch_assoc($sql4))
				{
				?>
	...
	<div class="form-group col-md-12">
			...
			<textarea id="message" required="required" class="form-control" name="observaciones" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comsment.." data-parsley-validation-threshold="10"></textarea>
	</div>
	<br>
