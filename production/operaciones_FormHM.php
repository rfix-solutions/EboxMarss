...
SELECT
	...
	ac.empresa_constructora AS CONSTRUCTORA,
...
FROM
TBL_AgendaVisita ag, TBL_Laboratorista l, TBL_FormAC ac
WHERE
	ag.id_agendamiento_visita = '".$_GET['id']."' AND
	ag.id_laboratorista = l.id_laboratorista AND
	ag.id_form_aceptacion = ac.id_form_aceptacion
";
...
while($fila = mysqli_fetch_assoc($sql)){
	...
	$if_construye = $fila['CONSTRUCTORA'];
	$if_fecha = $fila['FECHA'];
	$if_email = $fila['EMAIL'];
...
<form name="form_ch"class="form-horizontal form-label-left" action="operaciones_FormHMres.php" method="get">
...
<!-- /////////////////////////// SECCION 1 ///////////////////////////////////////// -->
	...
	<div class="form-group row">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<input type="text" class="form-control" name="correlativo_obra" required placeholder="Correlativo Obra">
			</div>
	</div>
	...
	<div class="form-group row">
    	...
    	<div class="col-md-4 col-sm-4 col-xs-12">
      	<input type="text" class="form-control" name="construye" placeholder="Construye" readonly required value="<?php echo $if_construye?>">
			</div>
	</div>
    ...
    <div class="col-md-3 col-sm-3 col-xs-12">
      ...
      <input type="number" required class="form-control" name="kilometraje" placeholder="Escriba" pattern="[0-9]" min=0>
		</div>
	</div>
...
<!-- ///////////// curado: 1=humeda; 2=Inmersion /////////////-->
	<div class="form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12" >
			...
			<div class="row">
				<label class="control-label col-md-4 col-sm-4 col-xs-12">Hora Llegada Obra</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
...
<!-- ////////////////////////// Textura: 1 = normal; 2 = ripiosa; 3 = arenosa //////////////////////////-->
	...
	<div class="form-group">
		...
		<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="number" step=".01" class="form-control" placeholder="Escriba" name="TempHormigon">
		</div>
		<label class="col-md-3 col-sm-3 col-xs-12 control-label">Temperatura de Ambiente (°C)</label>
		<div class="col-md-3 col-sm-3 col-xs-12">
			<input type="number" step=".01" class="form-control" placeholder="Escriba" name="TempAmbiente">
		</div>
	</div>
...
<!-- /////////////////////////// SECCION 4 ///////////////////////////////////////// -->
  ...
  <div class="form-group">
	...
	<div class="form-group row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<button type="button" onclick="location.href='operaciones_ingreso_formulario_reg.php?id=<?php echo $_GET['id'];?>'" class="btn btn-danger">Cancelar</button>
