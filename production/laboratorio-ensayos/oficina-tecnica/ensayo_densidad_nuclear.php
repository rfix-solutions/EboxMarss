  <form method="get" action="laboratorio-ensayos/oficina-tecnica/ensayo_densidad_nuclear_res.php" name="form_densidad_nuclear" id="form_densidad_nuclear">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <table id="tablas" class="table table-bordered" style="font-size: 10px;">
        <tr>
          <td>TIPO DE DENSIDAD</td>
          <td>
            <select>
              <option value=""> -- Tipo de Densidad --</option>
              <option value="1">Proctor (DMCS)</option>
              <option value="2">Densidad Relativa(DMAX - DMIN)</option>
            </select>
          </td>
        ...
        <tbody>
          <tr>
            ...
            <td><input type="text" name="referencia_1" style="width:100%;"></td>
            <td><input type="text" name="referencia_2" style="width:100%;"></td>
            <td><input type="text" name="referencia_3" style="width:100%;"></td>
          </tr>
          <tr>
            <td>DENSIMETRO MARCA</td>
            <td colspan="3"><input type="text" name="densimetro" style="width:100%;"></td>
          </tr>
          <tr>
            <td>FECHA DE CONTROL</td>
            <td><input type="date" style="width:100%;" name="fecha_ensayo_51" id="fecha_ensayo_51" value=""></td>
          </tr>
