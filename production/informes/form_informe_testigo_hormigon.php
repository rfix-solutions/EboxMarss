...
<!-- SECCION 1 -->
								...
								<div class="col-md-6 col-sm-6 col-xs-12" style="text-align:left; margin-top:5px;font-size: 14px; text-align: center; color: black; padding-top:10px; height:30px;">
									LABORATORIO DE OBRAS CIVILES LP 83579 / 17
								</div>
...
<!-- SECCION 2 -->
		                  ...
		                  <tr>
		                    ...
		                    <td></td>
											...
											<tr>
		                  	<th scope="row">Fecha Fabricación</th>
		                  	<td></td>
...
<!-- SECCION 3-->
							<div class="x_content">
								<div class="col-md-12 col-sm-12 col-xs-12 contenedor" style="margin-top:10px;">
									<p style="text-align:left; font-weight: bold;">RESULTADOS:</p>
									<p class="resultado_titulo">Informe de Extracci&oacute;n:</p>
									<p class="resultado_texto">SE EXTRAE UN TESTIGO DE HORMIGÓN Y SE TRASLADA A LABORATORIO PARA SU ACONDICIONAMIENTO Y ENSAYO.</p>
									<p class="resultado_titulo">Procedimiento de aserrado y refrentado:</p>
									<p class="resultado_texto">LOS TESTIGOS SE CORTAN CON SIERRA CIRCULAR Y SE REFRENTAN CON MEZCLA DE AZUFRE - ARENA ANTES DE SU ENSAYO A COMPRESIÓN.</p>
									<p class="resultado_titulo">Condiciones de conversaci&oacute;n:</p>
									<p class="resultado_texto">LOS TESTIGOS SE CONSERVAN SUMERGIDOS POR UNA HORA ANTES DE SU PREPARACIÓN PARA ENSAYO.</p>
								</div>
							</div>
								...
								<div class="x_content">
									<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
										<table style="margin-bottom:10px;">
											...
											<tr>
												<th colspan="7" style="text-align:center;">
													EXTRACCIÓN Y DETERMINACIÓN DE ESPESOR EN TESTIGOS DE HORMIGÓN</br>NCh 1171 Of 2012</th>
											</tr>
											</thead>
											<tbody>
											<tr >
												<td style="width:20%" >Testigo N&uacute;mero </td>
										...
										<tr>
											<th colspan="7" style="text-align:center;">
												ENSAYO DE COMPRESIÓN EN TESTIGOS DE HORMIGÓN</br>NCh 1172 Of 2010	NCh 1037 Of 2009		</th>
										</tr>
										</thead>
										<tbody>
											<tr>
											...
											<tr>
												<td>Densidad Método volumétrico (Kg/m3)	</td>
												<td></td>
												<td></td>
												<td></td>
												<td></td>
											...
											<tr>
												<td>Resistencia del testigo (MPa)</td>
												<td></td>
												<td></td>
												<td></td>
												<td></td>
											...
											<tr>
												<td>Resistencia cilindrica (MPa)</td>
												<td></td>
												<td></td>
												<td></td>
												<td></td>
											...
											<tr>
												<td>Resistencia c&uacute;bica NCh 170 of 85 (MPa)</td>
												<td></td>
												<td></td>
												<td></td>
												<td></td>
										...
										<table style="margin-bottom:10px;">
											...
											<tr>
												<th colspan="7" style="text-align:center;">
													Identificación de los testigos	</th>
											</tr>
											</thead>
											<tbody>
												<tr >
