...
$pdf->Cell(75,5,utf8_decode($Direccion),1,0,'L');
$pdf->Cell(40,5,utf8_decode('N° GUIA DESPACHO'),1,0,'L');
...
$pdf->Cell(35,5,utf8_decode('Asentamiento Cono'),1,0,'L');
...
$pdf->Cell(35,5,utf8_decode('Temperatura Hormigón'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($THormigon),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Aspecto'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Aspecto),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Lugar de Extracción'),1,0,'L');
...
$pdf->Cell(35,5,utf8_decode('Características de Mezclado'),1,0,'L');
$pdf->Cell(25,5,utf8_decode('///////////'),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Procedencia'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Procedencia),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Cantidad Probetas'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($CantidadMuestras),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Elemento Hormigonado'),1,0,'L');
$pdf->Cell(75,5,utf8_decode($ElemHormigonado),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Volumen Muestreado'),1,0,'L');
...
$pdf->Cell(50,5,utf8_decode('NCh 1017 2009'),1,0,'J', FALSE);
$pdf->Cell(105,5,utf8_decode('Confección y curado en obra de probetas para ensayos de compresión y tracción.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('NORMAS'),1,0,'L', TRUE);
$pdf->Cell(50,5,utf8_decode('NCh 1019 Of 2009	'),1,0,'J', FALSE);
$pdf->Cell(105,5,utf8_decode('Determinación de la docilidad del hormigón fresco. Método de asentamiento del cono de Abrams.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('DE'),1,0,'L', TRUE);
$pdf->Cell(50,5,utf8_decode('NCh 1172 Of 2010'),1,0,'J', FALSE);
$pdf->Cell(105,5,utf8_decode('Refrentado de probetas.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('REFERENCIA'),1,0,'L', TRUE);
$pdf->Cell(50,5,utf8_decode('NCh 1037 2009	'),1,0,'J', FALSE);
$pdf->Cell(105,5,utf8_decode('Ensaye de compresión de probetas cúbicas y cilíndricas.'),1,1,'J');
...
$pdf->Cell(15,5,utf8_decode('Edad'),1,0,'C', TRUE);
$pdf->Cell(15,5,utf8_decode('Area'),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('Densidad Aparente'),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('Carga Máxima'),1,0,'C', TRUE);
$pdf->Cell(30,5,utf8_decode('Resistencia a Compresion'),1,0,'C', TRUE);
$pdf->Cell(45,5,utf8_decode('Resistencia Cubica NCh 170 of 85'),1,1,'C', TRUE);

$pdf->Cell(35,5,utf8_decode(''),1,0,'C', TRUE);
$pdf->Cell(15,5,utf8_decode('(DIAS)'),1,0,'C', TRUE);
$pdf->Cell(15,5,utf8_decode('(mm2)'),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('(kg/m3)'),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('(kN)'),1,0,'C', TRUE);
$pdf->Cell(30,5,utf8_decode('(MPa)'),1,0,'C', TRUE);
$pdf->Cell(45,5,utf8_decode('(MPa)'),1,1,'C', TRUE);

$pdf->Cell(35,10,utf8_decode($FechaEnsayo),1,0,'C');
$pdf->Cell(15,10,utf8_decode($Edad),1,0,'C');
$pdf->Cell(15,10,utf8_decode($Area),1,0,'C');
$pdf->Cell(25,10,utf8_decode($DensidadAparente),1,0,'C');
$pdf->Cell(25,10,utf8_decode($CargaMax),1,0,'C');
$pdf->Cell(30,10,utf8_decode($ResistenciaComp),1,0,'C');
