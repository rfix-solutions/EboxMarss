...
$pdf->Cell(25,5,utf8_decode($AtSenor),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Ubicación Obra'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Direccion),1,0,'L');
...
$pdf->SetFillColor(220,220,220);
$pdf->Cell(110,5,utf8_decode('CARACTERISTICAS Y PROPIEDADES DEL HORMIGÓN FRESCO'),1,0,'C', TRUE);
$pdf->Cell(40,5,utf8_decode('Curado en Obra'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($Curado),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Asentamiento de Cono'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Cono),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Tipo Transporte'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Transporte),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Tipo Muestra'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($Tipo),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Temperatura de Hormigón'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($THormigon),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Aspecto'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Aspecto),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Lugar Extracción'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($LugarExtraccion),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Temperatura Ambiente'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($TAmbiente),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Textura'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($Textura),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Tipo Compactación'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($Tipo),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Aditivos Utilizados'),1,0,'L');
$pdf->Cell(75,5,utf8_decode($Aditivos),1,0,'L');
$pdf->Cell(40,5,utf8_decode('N° Guía Despacho'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($Guia),1,1,'L');


$pdf->SetFillColor(220,220,220);
$pdf->Cell(110,5,utf8_decode('ANTECEDENTES DEL HORMIGÓN'),1,0,'C', TRUE);
$pdf->Cell(40,5,utf8_decode('Curado en Laboratorio'),1,0,'L');
$pdf->Cell(40,5,utf8_decode("Inmersión"),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Resistencia Característica'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($DosificacionArray[1]),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Nivel de Confianza'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($DosificacionArray[2]."%"),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Tipo de Probeta'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($Tipo),1,1,'L');

$pdf->Cell(35,5,utf8_decode('Dosificación'),1,0,'L');
$pdf->Cell(25,5,utf8_decode($DosificacionTxt),1,0,'L');
$pdf->Cell(25,5,utf8_decode('Código Obra'),1,0,'L');
$pdf->Cell(25,5,utf8_decode('////////////'),1,0,'L');
$pdf->Cell(40,5,utf8_decode('Dimensiones'),1,0,'L');
$pdf->Cell(40,5,utf8_decode($Probeta),1,1,'L');


$pdf->Ln();
$pdf->SetFillColor(220,220,220);
$pdf->Cell(35,5,utf8_decode('ENSAYOS SOLICITADOS '),1,0,'L', TRUE);
$pdf->Cell(40,5,utf8_decode('NCh 171 2008'),1,0,'J', FALSE);
$pdf->Cell(115,5,utf8_decode('Extracción de muestras de hormigón fresco.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('Y '),1,0,'L', TRUE);
$pdf->Cell(40,5,utf8_decode('NCh 1017 2009'),1,0,'J', FALSE);
$pdf->Cell(115,5,utf8_decode('Confección y curado en obra de probetas para ensayos de compresión y tracción.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('NORMAS'),1,0,'L', TRUE);
$pdf->Cell(40,5,utf8_decode('NCh 1019 Of 2009	'),1,0,'J', FALSE);
$pdf->Cell(115,5,utf8_decode('Determinación de la docilidad del hormigón fresco. Método de asentamiento del cono de Abrams.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('DE'),1,0,'L', TRUE);
$pdf->Cell(40,5,utf8_decode('NCh 1172 Of 2010	'),1,0,'J', FALSE);
$pdf->Cell(115,5,utf8_decode('Refrentado de probetas.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('REFERENCIA'),1,0,'L', TRUE);
$pdf->Cell(40,5,utf8_decode('NCh 1037 2009		'),1,0,'J', FALSE);
$pdf->Cell(115,5,utf8_decode('Ensaye de compresión de probetas cúbicas y cilíndricas.'),1,1,'J');
...
$pdf->SetFont('Arial','',7);
$pdf->SetFillColor(220,220,220);
$pdf->Cell(26,5,utf8_decode('FECHA DE ENSAYO'),1,0,'C', TRUE);
$pdf->Cell(10,5,utf8_decode('EDAD'),1,0,'C', TRUE);
$pdf->Cell(10,5,utf8_decode('AREA'),1,0,'C', TRUE);
$pdf->Cell(28,5,utf8_decode('DENSIDAD APARENTE'),1,0,'C', TRUE);
$pdf->Cell(38,5,utf8_decode('RESISTENCIA A COMPRESIÓN'),1,0,'C', TRUE);
$pdf->Cell(32,5,utf8_decode('RESISTENCIA A FLEXIÓN'),1,0,'C', TRUE);
$pdf->Cell(46,5,utf8_decode('RESISTENCIA CUBICA NCh 170 of 85'),1,1,'C', TRUE);

$pdf->Cell(26,5,utf8_decode(''),1,0,'C', TRUE);
$pdf->Cell(10,5,utf8_decode('(DIAS)'),1,0,'C', TRUE);
$pdf->Cell(10,5,utf8_decode('(mm2)'),1,0,'C', TRUE);
$pdf->Cell(28,5,utf8_decode('(kg/m3)'),1,0,'C', TRUE);
$pdf->Cell(38,5,utf8_decode('(kN)'),1,0,'C', TRUE);
$pdf->Cell(32,5,utf8_decode('(MPa)'),1,0,'C', TRUE);
$pdf->Cell(46,5,utf8_decode('Compresion (MPa)'),1,1,'C', TRUE);


$pdf->Cell(26,10,utf8_decode($FechaEnsayo),1,0,'C');
$pdf->Cell(10,10,utf8_decode($Edad),1,0,'C');
$pdf->Cell(10,10,utf8_decode($Area),1,0,'C');
$pdf->Cell(28,10,utf8_decode($DensidadAparente),1,0,'C');
$pdf->Cell(38,10,utf8_decode($ResistenciaComp),1,0,'C');
$pdf->Cell(32,10,utf8_decode($ResistenciaComp),1,0,'C');
$pdf->Cell(46,10,utf8_decode($ResistenciaComp),1,1,'C');

$pdf->Ln(2);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(105,5,utf8_decode('RESISTENCIA CUBICA NCH 170 OF 85 FUERA DEL ALCANCE DE LA ACREDITACIÓN.'),0,1,'J');
$pdf->Ln(2);
...
$pdf->Ln(2);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(105,5,utf8_decode('OBSERVACIONES RELATIVAS AL HORMIGON DESPUES DE LA ROTURA:'),0,1,'J');
$pdf->SetFont('Arial','',8);
