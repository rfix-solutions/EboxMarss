...
while($HM1_Dat = mysqli_fetch_assoc($HM1_Sql)){
	...
	$ElemHormigonado	= $HM1_Dat['ELEMENTOHORMIGONADO'];
...
<!-- SECCION 2 -->
		                  ...
		                  <tr>
		                    ...
		                    <td colspan="3"><?php echo $AtSenor;?></td>
												<th scope="row">Muestra tomada por</th>
		                    <td><?php echo $RealizadoPor;?></td>
		                  </tr>
											<tr>
		                   	<th scope="row">Ubicacion Obra</th>
		                    <td colspan="3">//DEFINIR DATO//</td>
			                 	...
			                 	<th style="background: #EDEDED;" scope="row" colspan="4" style="text-align:center;">CARACTERISTICAS Y PROPIEDADES DEL HORMIGÓN FRESCO</th>
												<th scope="row" >Tipo Curado</th>
												<td><?php echo $Curado;?></td>
			                </tr>
										</tbody>
										<tr>
											<th scope="row">Objetivo de Mezcla</th>
											<td><?php //echo $Cono;?></td>
										...
										<tr>
											<th scope="row">Materiales Empleados</th>
											<td>////DEFINIR DATO/////</td>
											<th scope="row">Contenido de Aire</th>
											<td><?php //echo $Aspecto;?></td>
											<th scope="row">Tipo de Moldes</th>
											<td><?php echo $Tipo; ?></td>


										</tr>
										<tr>
											<th scope="row">Procedencia de Materiales</th>
											<td>////DEFINIR DATO/////</td>
											<th scope="row">Tipo Mezclador</th>
										...
										<tr>
											<th scope="row">Temperatura de Mezcla</th>
											<td><?php echo $THormigon;?></td>
											<th scope="row">Dosificacion</th>
										...
										<tr>
											...
											<th scope="row">Humedad Ambiente</th>
											<td><?php //echo $Compresion;?></td>
										</tr>
										<tr>
											<th scope="row">Elemento Muestreado</th>
											<td colspan="3"><?php echo $ElemHormigonado;?></td>
											<th scope="row">Volumen Amasada</th>
...
<!-- SECCION 3-->
										...
										<table>
											<tbody>
												<tr>
													...
													<td>
														NCh 171 2008</br>
														NCh 2257/3 Of 1996</br>
														NCh 158 Of 1967</br>
														NCh 2261 2010
													</td>
													<td>
														Extracción de muestras de hormigón fresco. </br>
														Determinación de la consistencia. Método del asentamiento del cono.</br>
									...
									<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
										...
										<table>
												...
												<tr>
													...
													<th style="background: #EDEDED;">Resistencia a </br> Compresion (Kn) </th>
													<th style="background: #EDEDED;">Resistencia a </br> Flexión (MPa) </th>
												</tr>
								...
								<div class="x_content">
									<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
										<div>
											<table>
												<tr>
													<th>LOS VALORES INDICADOS CORRESPONDEN AL PROMEDIO DE TRES PROBETAS ENSAYADAS.</th>
												</tr>
												<tr>
												...
												<tr>
													<th>OBSERVACIONES RELATIVAS AL MORTERO DESPUES DE LA ROTURA:</th>
												</tr>
												<tr>
													<td><?php echo $Obs; ?></td>
												</tr>
	 ...
	 <script>
	 	function aprobar(){
			alert('Aprobado');
			location.href="InformeRIHOROF_PDF.php?idi=<?php echo $InformeId;?>&foi=<?php echo $InformeFolio;?>";
		}
	 </script>
</body>
</html>
