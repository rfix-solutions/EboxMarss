...
$pdf->Cell(40,5,utf8_decode('Dato a rellenar'),1,1,'L');
...
$pdf->Cell(35,5,utf8_decode('Temperaruta Ambiente'),1,0,'L');
...
$pdf->Cell(40,5,utf8_decode('Tipo Probeta'),1,0,'L');
...
$pdf->Cell(35,5,utf8_decode('Características Mezclado'),1,0,'L');
$pdf->Cell(25,5,utf8_decode(''),1,0,'L');
...
$pdf->Cell(75,5,utf8_decode($ElementoHormigonado),1,0,'L');
...
$pdf->Cell(50,5,utf8_decode('NCh 171.E Of 1975'),1,0,'J', FALSE);
...
$pdf->Cell(105,5,utf8_decode('Ensaye de flexión y compresión de morteros de cemento.'),1,1,'J');

$pdf->Cell(35,5,utf8_decode('REFERENCIA'),1,0,'L', TRUE);
$pdf->Cell(50,5,utf8_decode('NCh 2261 Of 2009'),1,0,'J', FALSE);
...
$pdf->Cell(25,5,utf8_decode('Edad'),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('Area'),1,0,'C', TRUE);
...
$pdf->Cell(25,5,utf8_decode('Tipo de Rotura'),1,1,'C', TRUE);

$pdf->Cell(35,5,utf8_decode(''),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('(DIAS)'),1,0,'C', TRUE);
$pdf->Cell(25,5,utf8_decode('(mm2)'),1,0,'C', TRUE);
...
$pdf->Cell(25,10,utf8_decode($Edad),1,0,'C');
$pdf->Cell(25,10,utf8_decode($Area),1,0,'C');
