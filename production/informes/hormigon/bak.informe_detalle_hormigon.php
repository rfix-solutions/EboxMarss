...
$SQL_HeaderInforme = mysqli_query($link, $QRY_HeaderInforme) or die ("Error en SQL Header".mysqli_error($link));;
			...
			<div id="pagina" class="col-sm-12 col-md-12 col-xs-12">
				...
				<div class="x_content">
		          ...
		          <tr>
		            ...
		            <td><?php echo $NumeroSolicitud?></td>
							...
							<tr>
		           	<th scope="row">Fecha Fabricaci&oacute;n</th>
		            ...
		            <td colspan="3"><input type="text" style="width: 100%;" name="material_controlado" id="material_controlado"></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div class="x_content">
				    ...
				    while ($item_a = mysqli_fetch_assoc($SQL_91)) {?>
				      ...
				      <tr>
				        <td><input type="text" class="form-control" name="<?php echo $item_a['id_ensayo_item']?>" id="<?php echo $item_a['id_ensayo_item']?>" value=""></td>
				      </tr>
				    <?php
				    }
				    ?>
				  ...
				  <table class="table table-bordered" style="font-size: 10px; width:100%;" >
				    <thead style="background: #EDEDED;">
				      <tr>
				        <th colspan="6">EXTRACCIÓN Y DETERMINACIÓN DE ESPESOR EN TESTIGOS DE HORMIGÓN</th>
				        <th colspan="2" >NCh 1171 Of 2012</th>
				      </tr>
				    </thead>
				    <tbody>
				      <tr>
				      ...
				      <tr>
				        <td colspan="2" >Fecha Ensayo</td>
								<?php
								for($i=1;$i<=6;$i++){?>
				        <td><input style="width:100%;" type="text" name="fecha_ensayo_4" value=""></td>
								<?php
								}?>
				      </tr>
				    </tbody>
				  ...
				  <table class="table table-bordered" style="font-size: 10px; width:100%;" >
				    <thead style="background: #EDEDED;">
				      <tr>
				        <th colspan="6">ENSAYO DE COMPRESIÓN EN TESTIGOS DE HORMIGÓN</th>
				        <th colspan="2">NCh 1171 Of 2012</th>
				      </tr>
				    </thead>
				    <tbody>
