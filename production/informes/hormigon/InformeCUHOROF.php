...
$DosificacionTxt = "HB ".$DosificacionArray[0]."(".$DosificacionArray[1].")".$DosificacionArray[2]."/".$DosificacionArray[3];
...
<!-- SECCION 3-->
									...
									<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
										...
										<table>
												...
												<tr>
													...
													<th style="background: #EDEDED;">Tipo de rotura</th>
												</tr>
	 ...
	 <script>
	 	function aprobar(){
			alert('Aprobado');
			location.href="InformeCUHOROF_PDF.php?idi=<?php echo $InformeId;?>&foi=<?php echo $InformeFolio;?>";
		}
	 </script>
</body>
</html>
