...
<!-- SECCION 1 -->
								...
								<div class="col-md-6 col-sm-6 col-xs-12" style="text-align:left; margin-top:5px;font-size: 14px; text-align: center; color: black; padding-top:10px; height:30px;">
									LABORATORIO DE OBRAS CIVILES LA 84579 / 17
								</div>
											...
											<thead>
												<tr>
													<th colspan="4" style="text-align:center;">
														ANÁLISIS GRANULOMÉTRICO DE AGREGADOS PROVENIENTES DE EXTRACCIÓN ASFÁLTICA</br>
														MC Vol 8 - 8.302.27	MC Vol 8 - 8.302.28
													</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td style="width:20%; text-align: center" >Tamiz</td>
													<td style="text-align: center">% Acumulado que pasa</td>
													<td style="text-align: center" colspan="2">Banda de Trabajo según diseño</td>
												</tr>
											<tr>
												<td>SOBRETAMAÑO</td>
												<td></td>
									...
									<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
										<table>
											<thead>
												<tr>
													<th colspan="4" style="text-align:center;">
														DETERMINACIÓN DEL CONTENIDO DE BITUMEN EN MEZCLAS ASFÁLTICAS	</br>MC Vol 8 - 8.302.27	MC Vol 8 - 8.302.36
													</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td style="width:35%;" >CONTENIDO DE ASFALTO (Referencia a agregado)</td>
													<td colspan="3"></td>
												</tr>
											<tr>
												<td>CONTENIDO DE ASFALTO OPTIMO SEGÚN DISEÑO</td>
												<td></td>
												<td style="width:10%">+/-</td>
												<td></td>
											</tr>
											<tr>
												<td>SOLVENTE UTILIZADO</td>
												<td colspan="3"></td>
											</tr>
											<tr>
												<td> FECHA DE ENSAYO</td>
										...
										<table>
											<tr>
												<td style="width:35%">DISEÑO MARSHALL DE REFERENCIA</td>
												<td></td>
											</tr>
										</table>
									</div>
