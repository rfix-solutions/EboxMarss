	                			...
	                			<tr>
	                				<td>
	                					<table border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="logo">
				                			<tbody><tr>
				                				<td align="center">
													<a href="#" style="text-decoration:none"><img src="https://www.ebox.cl/production/images/logo_marss_400.png" alt=" " width="241" height="80" border="0"></a>
												</td>
				                			</tr>
				                		</tbody></table>
								...
								<table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="mainContent" bgcolor="f5f5f5">
									...
									<tr>
										<td style="font-size:25px; color:#0000FF; font-family:Gill Sans MT, Arial, sans-serif; padding-left: 70px; padding-right: 70px; font-style=italic;" align="center">
											<br>
											<a href="https://www.ebox.cl/production/form_aceptacion.php?id='.$cotizacion_id.'">Ver formulario de aceptaci&oacute;n</a>
										</td>
									</tr>
									<tr>
										<td style="font-size:25px; color:#0000FF; font-family:Gill Sans MT, Arial, sans-serif; padding-left: 70px; padding-right: 70px; font-style=italic;" align="center">
											<br>
											<a href="https://www.ebox.cl/production/cotizaciones/'.$cotizacion_numero.'.pdf">Ver Cotizaci&oacute;n</a>
										</td>
									</tr>
									</tbody>
								</table>
...
$cabeceras .= 'To: '.$cotizacion_contacto.' <'.$cotizacion_email.'>, RFIX <contacto@rfix.cl>' . "\r\n";
$cabeceras .= 'From: MarssLab <contacto@ebox.cl>' . "\r\n";
$cabeceras .= 'Cc: edmundo.sarria@tecnotrack.cl' . "\r\n";
$cabeceras .= 'Bcc: edmundo.sarria@clickagro.cl' . "\r\n";
...
if($enviado){
	...
	<script>
		...
		location.href="/production/dashboard_comercial.php";
	</script>
	<?php
}
?>
