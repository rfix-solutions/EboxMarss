      ...
      <div class="right_col" role="main">
				<div class="page-title">
					<div class="title_left">
						<h3>Clientes</h3>
						<a style="width:150px; text-align: center;" href="mant_clientes_opt.php?opt=0&id=0" class="btn btn-xs color bg-blue">Agregar Cliente</a>
					</div>
				</div>
        <div class="clearfix"></div>
    		<div class="row">
								...
								<table id="datatable" style="width: 100%" class="table table-striped table-bordered dt-responsive nowrap" >
									...
									?>
										<tr>
											...
											<td>
												<button type="button" onclick="Javascript:location.href='mant_clientes_opt.php?opt=1&id=<?php echo $row['ID'];?>'" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Editar</button>
											</td>
											</tr>
									<?php
									}
